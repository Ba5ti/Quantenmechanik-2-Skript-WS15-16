...
\subsection{Absorpiton und Emission von elektromagnetischer Strahlung}
	...
	Intensität ists bestimmt durch $A_0^2$
		\begin{align*}
			\rightarrow I &= | \vec{S} | & \text{zeitliches Mittel ist nötig da $\vec{S}$ fluktuiert!}
		\end{align*}
	$| \vec{S} |$ ist Pointing-Vektor \marginpar{was soll der Strich darüber?}
		\begin{align*}
	...
	Mittlere Energiedichte der elektromagnetischen Welle
		\begin{align*}
			v (\vec{r}) &=
			\frac{1}{2} \left( E^2(\vec{r} , t) + B^2(\vec{r} , t) \right) = \frac{1}{c} |\vec{S}| = 
			\frac{I}{c} = \frac{\omega^2}{2 c^2} |A_0|^2 \\
			v (\omega) &= \frac{\omega^2}{2 c^2} |A_0|^2
		\end{align*}